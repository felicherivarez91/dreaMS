...
interface PatientRemoteDataSource {
    ...
    fun askServerForPatientData(userId:String, responseHandler:(userCollectionData:UserCollectionDataResponse?, error:Throwable?) -> Unit)
...
class PatientRepositoryRemoteDataSource : PatientRemoteDataSource {
    ...
    override fun askServerForPatientData(userId: String, responseHandler:(userCollectionData:UserCollectionDataResponse?, error:Throwable?) -> Unit) {
